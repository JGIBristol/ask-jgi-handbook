...
:::{image} ../../images/timesheet2.png
    :alt: Example of a timesheet totals sheet.
    :width: 500px
    :align: center
:::
...
Guidance for making payment claims in this way can be found on the [Claiming Staff Fees SharePoint](https://uob.sharepoint.com/sites/myerp/SitePages/Getting-paid-staff-fees.aspx).
